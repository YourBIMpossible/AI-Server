...
1. **Criterion 1 caveat:** from a tailnet device other than the box, run `curl -s -o /dev/null -w '%{http_code}' http://100.89.51.34:11434/v1/models`. Expect `200`, then record it here.
